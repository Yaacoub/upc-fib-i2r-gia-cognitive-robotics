...
from Pipelines.LLM.run_tests import run_tests
from Pipelines.LLM.translate_rdf_to_language import translate_rdf_to_language
...
def main() -> int:
    ...
    rewrite_rdf         = False # Whether to rewrite the language parsing or reuse cached parses
    ...
    for run in range(1, runs+1):
        ...
        # Translate RDF to human language
        # =========================
        print(f"Translating RDF to language...")
        translate_rdf_to_language(rewrite=rewrite_rdf)
        ...
        save_tests(results, "LLM")

        # Summarize results
        # =========================
        print("Summarizing results...")
        summarize_results(results, "LLM")
